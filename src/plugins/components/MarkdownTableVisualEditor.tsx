...
interface TableWikiLinkSuggestState {
    ...
    query: string;
    /** 候选条目。 */
    items: EditorWikiLinkSuggestionItem[];
    /** 当前选中候选索引。 */
...
export function MarkdownTableVisualEditor(props: MarkdownTableVisualEditorProps): ReactNode {
                    ...
                    <button
                        ...
                        onClick={(event) => {
                            ...
                            void openEditorWikiLinkTarget(
                                resolveEditorCapabilities(props.capabilities),
                                wikiLinkTarget,
    ...
    }), [props.capabilities, props.currentFilePath]);
    ...
    const refreshWikiLinkSuggestForInput = (
        ...
        wikiLinkSuggestDebounceTimerRef.current = window.setTimeout(() => {
            ...
            void suggestEditorWikiLinkTargets(
                resolveEditorCapabilities(props.capabilities),
                query,
                WIKILINK_SUGGEST_MAX_ITEMS,
            )
                .then((items) => {
