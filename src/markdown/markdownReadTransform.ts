 ...
 * @dependencies
 *  - yaml
 *  - ./markdownBlockDetector
 *  - ./wikiLinkParser
 *
 * @example
 *   const prepared = prepareMarkdownForReadMode("---\ntitle: Demo\n---\nSee [[Note|Alias]] and ==mark==");
 *   prepared.frontmatter[0]?.key // => "title"
 *   prepared.renderedMarkdown // => "See [Alias](/__obeditor_wikilink__/Note) and [mark](/__obeditor_highlight__/mark)"
 *
 * @exports
...
import { detectExcludedLineRanges } from "./markdownBlockDetector";
import { parseImageEmbedTarget } from "./imageEmbedLayout";
import { parseWikiLinkParts } from "./wikiLinkParser";

/** 阅读态 WikiLink href 路径前缀。 */
export const READ_MODE_WIKILINK_PROTOCOL = "/__obeditor_wikilink__/";
/** 阅读态图片嵌入 href 路径前缀。 */
export const READ_MODE_MEDIA_EMBED_PROTOCOL = "/__obeditor_media_embed__/";
/** 阅读态高亮 href 路径前缀。 */
export const READ_MODE_INLINE_HIGHLIGHT_PROTOCOL = "/__obeditor_highlight__/";
/** 阅读态标签 href 路径前缀。 */
export const READ_MODE_INLINE_TAG_PROTOCOL = "/__obeditor_tag__/";
/** 阅读态行内 LaTeX href 路径前缀。 */
export const READ_MODE_INLINE_LATEX_PROTOCOL = "/__obeditor_inline_latex__/";
/** 阅读态块级 LaTeX href 路径前缀。 */
export const READ_MODE_BLOCK_LATEX_PROTOCOL = "/__obeditor_block_latex__/";

const LEGACY_READ_MODE_WIKILINK_PATH_PROTOCOL = "/__ofive_wikilink__/";
const LEGACY_READ_MODE_MEDIA_EMBED_PROTOCOL = "/__ofive_media_embed__/";
const LEGACY_READ_MODE_INLINE_HIGHLIGHT_PROTOCOL = "/__ofive_highlight__/";
const LEGACY_READ_MODE_INLINE_TAG_PROTOCOL = "/__ofive_tag__/";
const LEGACY_READ_MODE_INLINE_LATEX_PROTOCOL = "/__ofive_inline_latex__/";
const LEGACY_READ_MODE_BLOCK_LATEX_PROTOCOL = "/__ofive_block_latex__/";
...
export function decodeReadModeWikiLinkHref(href: string | undefined): string | null {
    return decodeProtocolHref(
        href,
        READ_MODE_WIKILINK_PROTOCOL,
        LEGACY_READ_MODE_WIKILINK_PATH_PROTOCOL,
        LEGACY_READ_MODE_WIKILINK_PROTOCOL,
    );
}
...
export function decodeReadModeMediaEmbedHref(href: string | undefined): string | null {
    return decodeProtocolHref(href, READ_MODE_MEDIA_EMBED_PROTOCOL, LEGACY_READ_MODE_MEDIA_EMBED_PROTOCOL);
}
...
export function decodeReadModeHighlightHref(href: string | undefined): string | null {
    return decodeProtocolHref(href, READ_MODE_INLINE_HIGHLIGHT_PROTOCOL, LEGACY_READ_MODE_INLINE_HIGHLIGHT_PROTOCOL);
}
...
export function decodeReadModeTagHref(href: string | undefined): string | null {
    return decodeProtocolHref(href, READ_MODE_INLINE_TAG_PROTOCOL, LEGACY_READ_MODE_INLINE_TAG_PROTOCOL);
}
...
export function decodeReadModeInlineLatexHref(href: string | undefined): string | null {
    return decodeProtocolHref(href, READ_MODE_INLINE_LATEX_PROTOCOL, LEGACY_READ_MODE_INLINE_LATEX_PROTOCOL);
}
...
export function decodeReadModeBlockLatexHref(href: string | undefined): string | null {
    return decodeProtocolHref(href, READ_MODE_BLOCK_LATEX_PROTOCOL, LEGACY_READ_MODE_BLOCK_LATEX_PROTOCOL);
}
